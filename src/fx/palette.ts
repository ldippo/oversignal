export type Biome = "signal" | "ocean" | "forest" | "canyon";
...
export const SECTOR_THEMES: SectorTheme[] = [
  ...
  {
    name: "THE ABYSS", biome: "ocean",
    edgeLeft: 0x2ee6c8, edgeRight: 0x4e9aff, fog: 0x03141c, background: 0x020a10,
    gate: 0x2ee6c8, obstacle: 0xff5a7a, scrap: 0xaaf0ff,
    skyHorizon: 0x0a3a4a, skyZenith: 0x010608, celestial: 0xcfe8ff, celestialDir: [0.2, 0.5, -0.85],
  },
  {
    name: "EMBER FIELD", biome: "signal",
  ...
  },
  {
    ...
    edgeLeft: 0x8aff6a, edgeRight: 0xffc44e, fog: 0x0a1408, background: 0x050a04,
    gate: 0xd4ff4e, obstacle: 0xff6a3e, scrap: 0xffe08a,
    skyHorizon: 0x14320e, skyZenith: 0x020803, celestial: 0xfff2aa, celestialDir: [-0.4, 0.3, -0.85],
  },
  {
    name: "VIOLET DEEP", biome: "signal",
  ...
  {
    name: "RED CANYON", biome: "canyon",
    edgeLeft: 0xffa94e, edgeRight: 0xff5a3e, fog: 0x1c0a05, background: 0x0a0402,
    gate: 0xffc44e, obstacle: 0xff3e6a, scrap: 0x4ef3ff,
    skyHorizon: 0x4a2410, skyZenith: 0x0a0503, celestial: 0xffd08a, celestialDir: [0.55, 0.18, -0.8],
  },
  {
    name: "ACID RUN", biome: "signal",
